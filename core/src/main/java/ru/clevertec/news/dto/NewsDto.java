...
/**
 * DTO class for <b>SINGLE</b> News with the following fields:
 * id, title, text, createDate and username
 *
...
public class NewsDto implements Serializable {
    ...
    @Schema(description = "The content of the News", requiredMode = Schema.RequiredMode.REQUIRED, example = "Long and interesting content")
    private String text;
